...
public class AGeneticoP1F5 extends AGenetico {
	...
	public AGeneticoP1F5(int poblacion, int generaciones, double porcCruces, double porcMutacion, double precision, boolean elitismo, int tipoSel) {
		super(poblacion, generaciones, porcCruces, porcMutacion, precision, false, elitismo, tipoSel);
	...
	public void inicializar() {
		...
		for(int i = 0; i < tamPob; i++){
			poblacion[i] = new CromosomaP1F5(tolerancia);
		}
	}
	...
	private void seleccionTorneo(int tipo){
		Cromosoma subpoblacion[] = new CromosomaP1F5[2]; //Conjunto a valorar
		Cromosoma poblacionAux[] = new CromosomaP1F5[tamPob]; //Nueva generación
	...
	public void reproduccion(){
		...
		int puntoCruce;
		double prob;
		Cromosoma hijo1 = new CromosomaP1F5(tolerancia);
		Cromosoma hijo2 = new CromosomaP1F5(tolerancia);
		Random rnd = new Random();
	...
	private void cruce(Cromosoma padre1, Cromosoma padre2, Cromosoma hijo1, Cromosoma hijo2, int puntoCruce)
	{
		...
		// Primera fase
		while(i < CromosomaP1F5.N_GENES && k < puntoCruce)
		{
